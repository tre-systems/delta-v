...
**Still open:** any remaining translucent panels in `components.css`, and a pass to ensure forced-colors does not flatten game-over semantic colors where we still need victory/defeat distinction.
