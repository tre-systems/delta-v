...
Delta-V ships the **Worker and static assets as one version line** ([ARCHITECTURE.md](./ARCHITECTURE.md)). Use this list whenever you bump **`GameState.schemaVersion`**, change **S2C/C2S protocol** shapes, or alter **replay projection** semantics.
