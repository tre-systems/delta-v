...
describe('session-signals', () => {
  ...
  it('bundles main session effects behind a single disposer', () => {
    ...
    expect(deps.ui.setWaitingState).toHaveBeenLastCalledWith(null, false, 'biplanetary');
  ...
  it('syncs waiting screen copy from reactive session state', () => {
    ...
    expect(setWaitingState).toHaveBeenLastCalledWith(null, false, 'biplanetary');
    ...
    expect(setWaitingState).toHaveBeenLastCalledWith('ROOM1', false, 'biplanetary');
